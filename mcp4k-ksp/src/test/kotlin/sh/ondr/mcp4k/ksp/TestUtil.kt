 ...
 *                  For example "Mcp4kGeneratedToolRegistryInitializer" or "Mcp4kGeneratedGreetParameters".
 * @param packagePath The path to the generated package directory relative to "build/generated/ksp/jvm/jvmMain/kotlin".
 *                    For example "sh/ondr/mcp4k/generated".
 */
fun checkGeneratedFile(
	projectDir: File,
	className: String,
	packagePath: String = "sh/ondr/mcp4k/generated",
) {
	val generatedFile =
		File(
			projectDir,
