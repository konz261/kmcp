...
internal fun KmcpProcessor.generateInitializer() {
	...
	val code = buildString {
		...
		appendLine()
		appendLine("import sh.ondr.kmcp.runtime.core.KMCP")
		...
		for (helper in collectedPrompts) {
			...
			append("        val ${promptName}Arguments = listOf(")
			...
			appendLine("        )")
			appendLine("        KMCP.promptInfos[\"$promptName\"] = ${promptName}PromptInfo")
			appendLine("        KMCP.promptHandlers[\"$promptName\"] = $handlerClassName()")
			appendLine()
		}
