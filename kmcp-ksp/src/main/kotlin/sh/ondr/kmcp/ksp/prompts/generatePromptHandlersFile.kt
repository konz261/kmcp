...
fun KmcpProcessor.generatePromptHandlersFile() {
	...
	val code = buildString {
		...
		appendLine("import sh.ondr.kmcp.runtime.prompts.McpPromptHandler")
		...
		prompts.forEach { prompt ->
			...
			val fqParamsClass = "$kmcpParamsPackage.${prompt.paramsClassName}"
